import { SET_ACCOUNT, UPDATE_ACCOUNT, RESET_ACCOUNT } from '../utils/constants'; //import type for reducer action.type
...
const accountReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case UPDATE_ACCOUNT: //action of udpate account, updates account state with action func updateAccountBalance.  auto withdraw func goes here
